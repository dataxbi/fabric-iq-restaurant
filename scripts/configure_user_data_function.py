        ...
        json.dumps(
            {
                ...
                "manualFollowUp": [
                    ...
                    "Set CUSTOM_APP_CONNECTION_STRING inside function_app.py before publishing.",
                    ...
                    "Keep secrets out of git: never commit a real CUSTOM_APP_CONNECTION_STRING value.",
                ],
            },
            indent=2,
        )
